...
- (void)viewDidLoad
{
    ...
    NSArray *listArray = [[NSArray alloc] initWithObjects:@"RedHotChiliPeppers",@"nirvana", @"paramore", @"pinkfloyd",@"mychemicalromance",@"eagles", @"falloutboy",@"greenday",@"creed",@"bonjovi",@"beatles",nil];
    self.list = listArray;
}
